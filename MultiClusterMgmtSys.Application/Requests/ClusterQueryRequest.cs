...
/// 由 <see cref="MultiClusterMgmtSys.Application.Services.ClusterService"/> 的分页查询方法(GetPagedAsync)接收,
/// 翻译为纯数据查询对象 <see cref="MultiClusterMgmtSys.Application.Models.ClusterPageQuery"/> 后交给仓库执行。
/// </summary>
