...
public class WorkloadServiceTests : IDisposable
{
    ...
    public async Task ListDeploymentsAsync_missing_cluster_throws_not_found()
    {
        await Assert.ThrowsAsync<NotFoundException>(
            () => _service.ListDeploymentsAsync(new WorkloadQueryRequest(999, null)));
    }
    ...
    public async Task ListDeploymentsAsync_null_namespace_lists_all()
    {
        ...
        var items = await _service.ListDeploymentsAsync(new WorkloadQueryRequest(clusterId, null));
    ...
    {
        var clusterId = await SeedAsync();
        _k8s.SetupListNamespacedDeployments("app", new V1Deployment { Metadata = new V1ObjectMeta { Name = "ns-web", NamespaceProperty = "app" } });

        var items = await _service.ListDeploymentsAsync(new WorkloadQueryRequest(clusterId, "app"));
    ...
    {
        var clusterId = await SeedAsync();
        _k8s.SetupListDeploymentsThrows(K8sMocks.K8sError(404));

        await Assert.ThrowsAsync<NotFoundException>(
            () => _service.ListDeploymentsAsync(new WorkloadQueryRequest(clusterId, null)));
    }

    [Fact]
    public async Task GetDeploymentAsync_missing_cluster_returns_null()
    {
        Assert.Null(await _service.GetDeploymentAsync(new WorkloadKeyRequest(999, "web", "app")));
    }
    ...
    public async Task GetDeploymentAsync_maps_detail()
    {
        ...
        var detail = await _service.GetDeploymentAsync(new WorkloadKeyRequest(clusterId, "web", "app"));
    ...
    public async Task GetDeploymentAsync_k8s_404_translated()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(
            () => _service.GetDeploymentAsync(new WorkloadKeyRequest(clusterId, "ghost", "app")));
    }
    ...
    public async Task CreateDeploymentFromYamlAsync_invalid_yaml_throws_validation()
    {
        ...
        var ex = await Assert.ThrowsAsync<ValidationException>(
            () => _service.CreateDeploymentFromYamlAsync(new WorkloadCreateRequest(clusterId, "{ broken")));
    ...
    public async Task CreateDeploymentFromYamlAsync_success_audits()
    {
        ...
        await _service.CreateDeploymentFromYamlAsync(new WorkloadCreateRequest(clusterId, DeploymentYaml));
    ...
    {
        var clusterId = await SeedAsync();
        _k8s.SetupCreateDeploymentThrows("app", K8sMocks.K8sError(409));

        await Assert.ThrowsAsync<ConflictException>(
            () => _service.CreateDeploymentFromYamlAsync(new WorkloadCreateRequest(clusterId, DeploymentYaml)));
    }
    ...
    public async Task UpdateDeploymentFromYamlAsync_replaces_spec_and_audits()
    {
        ...
        await _service.UpdateDeploymentFromYamlAsync(new WorkloadUpdateRequest(clusterId, "web", "app", yaml));
    ...
    public async Task UpdateDeploymentFromYamlAsync_k8s_error_translated()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(
            () => _service.UpdateDeploymentFromYamlAsync(new WorkloadUpdateRequest(clusterId, "ghost", "app", DeploymentYaml)));
    }
    ...
    public async Task DeleteDeploymentAsync_k8s_error_translated()
    {
        ...
        await Assert.ThrowsAsync<ClusterUnreachableException>(
            () => _service.DeleteDeploymentAsync(new WorkloadKeyRequest(clusterId, "web", "app")));
    }
    ...
    public async Task ScaleDeploymentAsync_updates_replicas_and_audits()
    {
        ...
        await _service.ScaleDeploymentAsync(new WorkloadScaleRequest(clusterId, "web", "app", Replicas: 5));
    ...
    public async Task ScaleDeploymentAsync_k8s_error_translated()
    {
        ...
        var ex = await Record.ExceptionAsync(() => _service.ScaleDeploymentAsync(request));
        Assert.NotNull(ex);
    ...
    public async Task RestartDeploymentAsync_k8s_error_translated()
    {
        ...
        await Assert.ThrowsAsync<PermissionException>(
            () => _service.RestartDeploymentAsync(new WorkloadKeyRequest(clusterId, "web", "app")));
    }
    ...
    public async Task GetStatefulSetAsync_maps_detail()
    {
        ...
        var detail = await _service.GetStatefulSetAsync(new WorkloadKeyRequest(clusterId, "sts-1", "app"));
    ...
    public async Task GetDaemonSetAsync_maps_detail()
    {
        ...
        var detail = await _service.GetDaemonSetAsync(new WorkloadKeyRequest(clusterId, "ds-1", "app"));
    ...
    public async Task GetReplicaSetAsync_maps_detail()
    {
        ...
        var detail = await _service.GetReplicaSetAsync(new WorkloadKeyRequest(clusterId, "rs-1", "app"));
    ...
    {
        var clusterId = await SeedAsync();
        _k8s.SetupListStatefulSets(new V1StatefulSet { Metadata = new V1ObjectMeta { Name = "sts-1" } });

        var items = await _service.ListStatefulSetsAsync(new WorkloadQueryRequest(clusterId, null));
    ...
    {
        var clusterId = await SeedAsync();
        _k8s.SetupListDaemonSets(new V1DaemonSet { Metadata = new V1ObjectMeta { Name = "ds-1" } });

        var items = await _service.ListDaemonSetsAsync(new WorkloadQueryRequest(clusterId, null));
    ...
    {
        var clusterId = await SeedAsync();
        _k8s.SetupListReplicaSets(new V1ReplicaSet { Metadata = new V1ObjectMeta { Name = "rs-1" } });

        var items = await _service.ListReplicaSetsAsync(new WorkloadQueryRequest(clusterId, null));
    ...
    {
        var clusterId = await SeedAsync();
        _k8s.SetupCreateStatefulSet("app");

        var yaml = DeploymentYaml.Replace("kind: Deployment", "kind: StatefulSet").Replace("name: web", "name: sts-web");
        await _service.CreateStatefulSetFromYamlAsync(new WorkloadCreateRequest(clusterId, yaml));
    ...
    {
        var clusterId = await SeedAsync();
        _k8s.SetupCreateDaemonSet("app");

        var yaml = DeploymentYaml.Replace("kind: Deployment", "kind: DaemonSet").Replace("name: web", "name: ds-web");
        await _service.CreateDaemonSetFromYamlAsync(new WorkloadCreateRequest(clusterId, yaml));
    ...
    {
        var clusterId = await SeedAsync();
        _k8s.SetupCreateReplicaSet("app");

        var yaml = DeploymentYaml.Replace("kind: Deployment", "kind: ReplicaSet").Replace("name: web", "name: rs-web");
        await _service.CreateReplicaSetFromYamlAsync(new WorkloadCreateRequest(clusterId, yaml));
    ...
    public async Task ScaleStatefulSetAsync_updates_replicas_and_audits()
    {
        ...
        await _service.ScaleStatefulSetAsync(new WorkloadScaleRequest(clusterId, "sts-1", "app", Replicas: 4));

        _k8s.Verify(x => x.AppsV1.ReplaceNamespacedStatefulSetScaleWithHttpMessagesAsync(
    ...
    public async Task ScaleReplicaSetAsync_updates_replicas_and_audits()
    {
        ...
        await _service.ScaleReplicaSetAsync(new WorkloadScaleRequest(clusterId, "rs-1", "app", Replicas: 9));
    ...
    public async Task RestartStatefulSetAsync_audits_restart()
    {
        ...
        Assert.Equal(AuditAction.Restart, _harness.Db.AuditLogs.Single().Action);
    }
